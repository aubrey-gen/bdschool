	...
	<div class="container-fluid" id="main">
		...
		<div class="row" >
		  <div class="col-md-4 col-md-offset-3">
			<img src="images/tmp_content.png" class="img-rounded">
		  </div>			
		</div>
		...
		<div class="row" >
			<div class="col-md-4 col-md-offset-3">
				<div
					<address>			
					Manager: 072 096 7912<br/>
					<strong>Enquiries</strong>: 071 388 7255<br/>
					Email: tmaguvhe@yahoo.com<br/>
					<strong>Address</strong>: 10 Bason Street, Danville Ext 5, 0183<br/>
					</address>
				</div>
			</div>	
		</div>
